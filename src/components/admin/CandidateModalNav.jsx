...
/**
 * Верхняя панель навигации и действий модального окна кандидата.
 * Содержит: стрелки перелистывания, заголовок, кнопки сохранения / обновления / звонка / закрытия.
 */
export default function CandidateModalNav({
