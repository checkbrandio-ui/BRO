...
const documents = [
  {
    ...
    badgeColor: 'gold',
    details: [
      { label: 'Полное наименование', value: 'ООО «БРО-СНБ»' },
  ...
  },
  {
    ...
    date: '14.04.2026',
    description: 'Устав ООО «БРО-СНБ», утверждённый решением единственного учредителя №1. Определяет порядок деятельности общества.',
    badge: 'Действующий',
    badgeColor: 'gold',
    details: [
