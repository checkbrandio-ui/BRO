...
function buildTrudovoyDogovor(ctx) {
  ...
  <p>1.3. Место работы: объекты восстановления жилой, социальной и коммунальной инфраструктуры, расположенные на территории Луганской Народной Республики (ЛНР) и Донецкой Народной Республики (ДНР). Конкретный объект определяется Работодателем. Работник перемещается вахтовым методом из точки сбора (сборный пункт) к месту выполнения работ.</p>
  <p>1.4. Условия труда на рабочем месте: работа вахтовым методом на объектах восстановления в зоне особого контроля, что предполагает повышенную интенсивность, удалённость от постоянного места жительства и специфический режим труда и отдыха.</p>
  ...
  <p>5.4. <strong>Страхование (от несчастных случаев)</strong>: Работодатель обеспечивает Работника полной медицинской страховкой и страховкой от несчастных случаев на сумму до <strong>14 700 000 (четырнадцать миллионов семьсот тысяч) рублей</strong>. Страховка действует на всё время вахты, включая дорогу к месту работы и обратно.</p>
  ...
  <p>5.8. <strong>Обязательное социальное страхование</strong> (ОСС, ОМС, ОПС): Работодатель осуществляет в полном объёме в соответствии со ст. 22 ТК РФ, Федеральными законами № 125-ФЗ, № 326-ФЗ, № 167-ФЗ. Периоды работы засчитываются в страховой стаж.</p>
  ...
  <p>Индивидуальные трудовые споры рассматриваются комиссией по трудовым спорам или судом в порядке, установленном гл. 60 ТК РФ. Место рассмотрения — по выбору Работника: по месту нахождения Работодателя или по месту жительства Работника.</p>

  <p class="section-title">12. Заключительные положения</p>
  <p>12.1. Договор составлен в 2 (двух) экземплярах, имеющих одинаковую юридическую силу, по одному для каждой из сторон. Получение своего экземпляра Работник подтверждает подписью.</p>
  <p>12.2. Неотъемлемые приложения к настоящему Договору: Приложение № 1 — Размер должностного оклада; Должностная инструкция; Правила внутреннего трудового распорядка.</p>
  <p>12.3. Во всём остальном, не предусмотренном настоящим Договором, стороны руководствуются Трудовым кодексом РФ и иным действующим законодательством.</p>
...
function buildConsentPD(ctx) {
  ...
  <p>свободно, своей волей и в своём интересе даю согласие ${COMPANY.full_name} (ИНН: ${COMPANY.inn}, ОГРН: ${COMPANY.ogrn}, адрес: ${escapeHtml(COMPANY.address)}) на обработку моих персональных данных в соответствии со статьёй 9 Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных».</p>
