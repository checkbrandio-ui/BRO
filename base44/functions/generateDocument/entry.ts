...
function buildTrudovoyDogovor(ctx) {
  ...
  <p class="section-title">5. Социальный пакет и гарантии Работодателя</p>
  <p>5.1. <strong>Проживание (бесплатно)</strong>: Работодатель обеспечивает Работника бесплатным проживанием в условиях вахтового посёлка (комнаты 2–3 человека, Wi-Fi, телевизор). Расходы на проживание не вычитаются из заработной платы (ст. 297, 302 ТК РФ).</p>
  <p>5.2. <strong>Питание (бесплатно)</strong>: трёхразовое горячее питание за счёт Работодателя ежедневно в течение всей вахты. Питание организовано непосредственно на базе и на объектах.</p>
